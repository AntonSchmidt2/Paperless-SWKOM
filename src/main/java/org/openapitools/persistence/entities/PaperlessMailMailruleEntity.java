...
public class PaperlessMailMailruleEntity {
    ...
    @OneToMany(mappedBy = "mailRule")
    private Set<PaperlessMailMailruleAssignTagsEntity> assignTags;
    ...
    public void setAccount(PaperlessMailMailaccountEntity account) {
    ...
    public Set<PaperlessMailMailruleAssignTagsEntity> getAssignTags() {
        return assignTags;
    }

    public void setAssignTags(Set<PaperlessMailMailruleAssignTagsEntity> assignTags) {
